...
public:
  ...
  void forward_node_down(const node_id& sender, const node_id& source, const node_id& down_node, const error& fail_state);
  ...
  void send_basp_down_message(const node_id& to, const node_id& sender, const node_id& down_node, const error& rsn);
